    ...
    <div class="body">
        <div class="box left">
            ...
            <div class="product-seller">
                ...
                <a href='<c:url value="/userStore"></c:url>' class="more_btn" onmouseover="mouseOver1(this)" onmouseout="mouseOut1(this)">판매자 상품 보기
        ...
        <div class="box mid">
            ...
            <div class="chat-bottom">
                ...
                <button onmouseover="mouseOver1(this)" onmouseout="mouseOut1(this)" onclick="send()" type="button">전송</button>
            </div>
        </div>
        <div class="box right">
...
<script type="text/javascript">
        ...
        function openSocket(){
            ...
            //웹소켓 객체 만드는 코드
            ws = new WebSocket("ws://localhost:8080/chatting/echo.do");
