      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">패션</h1>
                     <div class="fashion_section_2">
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text">Man T -shirt</h4>
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 30</span></p>
                                 <div class="tshirt_img"><img src="<c:url value='/resources/images1/tshirt-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 30</span></p>
                                 <div class="tshirt_img"><img src="<c:url value='/resources/images1/dress-shirt-img.png'></c:url>"></div>
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 30</span></p>
                                 <div class="tshirt_img"><img src="<c:url value='/resources/images1/women-clothes-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
      ...
      <div class="fashion_section">
         <div id="electronic_main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">가전제품</h1>
                     <div class="fashion_section_2">
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 <h4 class="shirt_text">Laptop</h4>
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 100</span></p>
                                 <div class="electronic_img"><img src="<c:url value='/resources/images1/laptop-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 100</span></p>
                                 <div class="electronic_img"><img src="<c:url value='/resources/images1/mobile-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 100</span></p>
                                 <div class="electronic_img"><img src="<c:url value='/resources/images1/computer-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 100</span></p>
                                 <div class="jewellery_img"><img src="<c:url value='/resources/images1/jhumka-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 100</span></p>
                                 <div class="jewellery_img"><img src="<c:url value='/resources/images1/neklesh-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">입찰 시작가  <span style="color: #262626;">$ 100</span></p>
                                 <div class="jewellery_img"><img src="<c:url value='/resources/images1/kangan-img.png'></c:url>"></div> 
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">Buy Now</a></div>
                                    <div class="seemore_bt"><a href="#">See More</a></div>
                                 </div>
